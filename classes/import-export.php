										...
										if ( $csv = new smParseCSV( $file_location ) ) {
											...
											<form action="" method="post">
												...
												<p><input type="submit" class="button-primary"
												          value="<?php _e( 'Import CSV', 'SimpleMap' ); ?>"/> | <a
														href=''><?php _e( 'Cancel', 'SimpleMap' ); ?></a></p>
												<table>
													<tr>
														<?php
							...
							<div id='normal-sortables' class='meta-box-sortables ui-sortable'>
								...
								<div class="postbox">
									...
									<div class="inside" style="padding: 0 10px 10px 10px;">
										...
										<p>
											<em style="color: #777; font: italic 1.1em Georgia;"><?php _e( 'Name, Address, Address Line 2, City, State/Province, ZIP/Postal Code, Country, Phone, Fax, URL, Category, Tags, Days, Times, Description, Special (1 or 0), Latitude, Longitude', 'SimpleMap' ); ?></em>
										</p>
										...
										<form name="import_form" method="post"
										      action="<?php echo admin_url( 'admin.php?page=simplemap-import-export' ); ?>"
											...
											<p style="margin-top: 0;"><label
													for="simplemap-csv-upload"><?php _e( 'File to import (maximum size 2MB):', 'SimpleMap' ); ?></label><input
													type="file"
											...
											<input type="submit" class="button-primary"
											       value="<?php _e( 'Import CSV File', 'SimpleMap' ); ?>"/>
								...
								<div class="postbox">
									...
									<div class="inside" style="padding: 10px;">
										...
										<form name="export_form" method="post" action="">
											...
											<input type="submit" class="button-primary"
											       value="<?php _e( 'Export Database to CSV File', 'SimpleMap' ); ?>"/>
